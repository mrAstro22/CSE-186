 ...
 *
 * Three are allowed for the email list entrie, mailbox list entries
 * and perhaps a Context. You should be using at least one for the
 * email list entries.
 *
 ...
 */
test('Not Too Few or Too Many Components Using Props', async () => {
  const files = await readdir('src', {recursive: true});
  let cnt = 0;
  for (const file of files) {
