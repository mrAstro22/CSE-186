...
INSERT INTO posts (userid, groupid, data) VALUES
  ...
  ((SELECT id FROM users WHERE data->'user'->>'email' = 'molly@books.com'), (SELECT groupid FROM groups WHERE data->>'groupname' = 'Guitars'), json_build_object('content', 'Indian Sitar', 'date-posted', '2024-05-05T20:15:12.123Z', 'ispublic', false)),
